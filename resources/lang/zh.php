...
return [
    ...
    'messages' => [
        ...
        '100035' => '凯琳酱参上，FreeNom 续期工具有新的版本（v%s）可用，新版相关情况已给到你',
        '100036' => '有关新版的信息已送信给到你，请注意查收。',
        '100037' => '升级出错：',
        '100038' => '当前程序版本 %s',
        '100039' => '凯琳酱参上，我刚刚帮你续期域名啦~',
        ...
        '100070' => '无数据。',
        '100071' => '<a href="http://%s" rel="noopener" target="_blank">%s</a>EXP: <span style="font-weight: bold; font-size: 16px;">%d</span> D',
        '100072' => '。',
        '100073' => '凯琳酱参上',
        '100074' => '作者',
        '100075' => '续期成功：%s<br>',
        ...
        '100085' => '续期出错：',
        '100086' => "\n今次无需续期的域名及其剩余天数如下所示：\n\n",
        '100087' => "凯琳酱参上 例行检查完成，账户 %s 今天并没有需要续期的域名。所有域名情况如下：\n\n",
        '100088' => '未知原因',
        '100089' => 'Bark 送信失败：<red>%s</red>',
        '100090' => "凯琳酱参上 例行检查完成，账户 [%s](#) 今天并没有需要续期的域名。所有域名情况如下：\n\n",
        '100091' => "\n更多信息可以参考 [Freenom官网](https://my.freenom.com/domains.php?a=renewals) 哦~",
        '100093' => "无数据。\n",
        '100094' => '[%s](http://%s) EXP: *%d* D',
        '100095' => "。\n",
        ...
        '100102' => "凯琳酱参上 例行检查完成，账户 %s 今天并没有需要续期的域名。所有域名情况如下：\n\n",
        '100103' => "\n更多信息可以参考 [Freenom官网](https://my.freenom.com/domains.php?a=renewals) 哦~",
        '100105' => "无数据。\n",
        '100106' => "[%s](http://%s) EXP: *%d* D\n",
        '100107' => "。\n",
        ...
        '100118' => "无数据。\n",
        '100119' => '<a href="http://%s">%s</a> EXP: <a href="http://%s">%d</a> D',
        '100120' => "。\n",
        '100121' => "账户 <a href=\"https://www.google.com\">%s</a> 这次续期的结果如下\n\n",
        '100122' => '续期成功：',
        '100123' => '续期出错：',
        '100124' => "\n今次无需续期的域名及其剩余天数如下所示：\n\n",
        '100125' => "凯琳酱参上 例行检查完成，账户 <a href=\"https://www.google.com\">%s</a> 今天并没有需要续期的域名。所有域名情况如下：\n\n",
